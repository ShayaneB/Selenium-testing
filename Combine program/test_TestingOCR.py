...
class LoginLogout(unittest.TestCase):
    ...
    def test_login(self):
        self.driver.get("http://systest.eisenvault.net/share")
        self.driver.find_element_by_id("page_x002e_components_x002e_slingshot-login_x0023_default-username").send_keys("admin")
        self.driver.find_element_by_id("page_x002e_components_x002e_slingshot-login_x0023_default-password").send_keys("Admindms@123")
        ...
        element = self.driver.find_element_by_class_name('remote-ocr-english')
