...
class LoginLogout(unittest.TestCase):
    ...
    #Create Folder "Test".
        ...
        time.sleep(10)
        # # Find the department and go to the document library of the department.
        # self.driver.find_element_by_link_text("A_Test").click()
        # time.sleep(10) 
        # self.driver.find_element_by_id("HEADER_SITE_DOCUMENTLIBRARY_text").click()
        # time.sleep(10)
        ...
        dropzone = self.driver.find_element_by_id("template_x002e_documentlist_v2_x002e_documentlibrary_x0023_default-documents")
            # drop a single file
        dropzone.drop_files("/home/shayane/Desktop/TestingNewInstance.xlsx")
        time.sleep(10)
        # self.driver.find_element_by_id("HEADER_SITE_DOCUMENTLIBRARY_text").click()
        # time.sleep(10)

        #Click on folder and locate the document/folder which needs to be moved.
        # self.driver.find_element_by_id("ygtvlabelel7").click()
        # time.sleep(10)
        self.driver.find_element_by_xpath("//input[@value='workspace://SpacesStore/383a6489-c273-45f8-98b9-0c40c32714d8']").click()
        time.sleep(10)

        #Select the folder/file and move it to the selected location.
        self.driver.find_element_by_id("template_x002e_documentlist_v2_x002e_documentlibrary_x0023_default-selectedItems-button-button").click()
        time.sleep(5)
        self.driver.find_element_by_class_name("onActionMoveTo").click()
        time.sleep(5)
        self.driver.find_element_by_class_name("ygtvlabel").click()
        time.sleep(5)
        self.driver.find_element_by_id("template_x002e_documentlist_v2_x002e_documentlibrary_x0023_default-copyMoveTo-ok-button").click()
        time.sleep(10)
        ...
        # Locate the folder.
        element=self.driver.find_element_by_xpath("//input[@value='workspace://SpacesStore/52d3233c-e923-4b5b-963a-fae07e563fcd']")
        element.location_once_scrolled_into_view
        hov = ActionChains(self.driver).move_to_element(element)
        hov.perform()

        #Download the file as Zip.
        self.driver.find_element_by_id("onActionFolderDownload").click()
        time.sleep(15)
...
if __name__=='__main__':
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output='/home/shayane/Desktop/Testing/Reports/ReportsofPerformActions'))